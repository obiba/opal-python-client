...
class ProjectService:
    ...
    def add_arguments(cls, parser):
        ...
        parser.add_argument(
            ...
            nargs="+",
            required=False,
            help="Tags to apply to the project.",
        )
        parser.add_argument(
            "--export-folder",
            "-ex",
        ...
        parser.add_argument(
            ...
            "-a",
            action="store_true",
            help="Add a project (requires at least a project name).",
        )
        parser.add_argument(
            "--delete",
            "-de",
        ...
        parser.add_argument(
            ...
            "-f",
            action="store_true",
            help="Skip confirmation on project deletion",
        )
        parser.add_argument(
            "--json",
            "-j",
...
class BackupProjectCommand:
    ...
    def add_arguments(self, parser):
        ...
        parser.add_argument(
            ...
            "-ar",
            required=True,
            help="Archive directory path in the Opal file system",
        )
        parser.add_argument(
            "--views-as-tables",
            "-vt",
        ...
        parser.add_argument(
            ...
            "-f",
            action="store_true",
            help="Force overwriting an existing backup folder",
        )
        parser.add_argument(
            "--json",
            "-j",
    ...
    def do_command(self, args):
        ...
        client = core.OpalClient.build(core.OpalClient.LoginInfo.parse(args))
        try:
            res = BackupProjectCommand(client, args.verbose).backup_project(
                args.project, args.archive, args.views_as_tables, args.force
            )
            # format response
            core.Formatter.print_json(res, args.json)
        finally:
...
class RestoreProjectCommand:
    ...
    def add_arguments(cls, parser):
        ...
        parser.add_argument(
            ...
            "-pr",
            required=True,
            help="Destination project name (must exist)",
        )
        parser.add_argument(
            "--archive",
            "-ar",
        ...
        parser.add_argument(
            ...
            "-arp",
            required=False,
            help="Password to decrypt zip archive (optional)",
        )
        parser.add_argument(
            "--force",
            "-f",
